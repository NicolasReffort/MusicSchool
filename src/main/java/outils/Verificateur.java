...
public class Verificateur{
   ...
   * (TO DO : utiliser la généricité pour l'étendre à tous les objets)
   * @return liste d'erreur vide si pas d'erreur, 
   * sinon retour une liste des messages d'erreur, en String. 
   */
  public static List<String> areMyAttributesOk(final Personne unePersonne) {
